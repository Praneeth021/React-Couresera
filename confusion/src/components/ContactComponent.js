...
import {Breadcrumb,BreadcrumbItem,Form,FormFeedback,FormGroup,Label,Button,Input,Col} from 'reactstrap';
                ...
                <div className='row row-content'>
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <Col md={10}>
                                <Input type='tel' id='telnum' name='telnum' placeholder='Contact No' value={this.state.telnum} onChange={this.handleChange} />
                            </Col>
                            </FormGroup>
                            <FormGroup row>
